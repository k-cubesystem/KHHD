...
<Card>
  {/* 배경 */}
  bg-gradient-to-br from-stone-800/30 to-stone-900/20 border-stone-700/30 hover:border-gold-500/30
  {/* Noise Overlay */}
  {/* 아바타 */}
  bg-gradient-to-br from-gold-500/20 to-gold-600/5 border-gold-500/20 text-gold-400
  {/* Role Select */}- admin: bg-red-500/10 text-red-400 border-red-500/30 - tester: bg-yellow-500/10 text-yellow-400
  border-yellow-500/30 - user: bg-stone-700/30 text-stone-400 border-stone-600/30
  {/* 버튼 */}- 편집: hover:text-gold-400 hover:bg-stone-800/50 - 삭제: hover:text-red-400 hover:bg-red-500/10
  {/* Shine Effect */}
</Card>
```
