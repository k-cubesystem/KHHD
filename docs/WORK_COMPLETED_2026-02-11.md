...
```tsx
<section>
  <h2 className="text-xl font-bold text-white mb-4">섹션 제목</h2>
  <p className="text-sm text-white/70">설명 텍스트</p>
  <Button className="bg-primary text-black font-bold">액션 버튼</Button>
</section>
```
