...
| 파일                                                         | 내용                                                |
| ------------------------------------------------------------ | --------------------------------------------------- |
| **[ARCHITECTURE.md](./ARCHITECTURE.md)**                     | 기술 스택, 폴더 구조, DB 테이블, 인증/결제 흐름     |
| **[DATABASE.md](./DATABASE.md)**                             | DB 스키마 상세, RPC 함수, 마이그레이션 현황         |
| **[DESIGN.md](./DESIGN.md)**                                 | 디자인 시스템, 컬러, 컴포넌트 패턴, 모바일 규칙     |
| **[DEVELOPER.md](./DEVELOPER.md)**                           | 개발 환경, 코드 규칙, API 레퍼런스                  |
| **[AI_GUIDE.md](./AI_GUIDE.md)**                             | Gemini 설정, 프롬프트 관리, Claude 작업 원칙        |
| **[PLANNING.md](./PLANNING.md)**                             | 프로젝트 비전, 수익 모델, 기능 목록, 현재 개발 단계 |
| **[CHANGELOG.md](./CHANGELOG.md)**                           | 버전별 변경 이력                                    |
| **[DESTINY_SYSTEM_GUIDE.md](./DESTINY_SYSTEM_GUIDE.md)**     | Destiny Target 기능 가이드                          |
| **[BOKCHAE_SYSTEM_WORKLOG.md](./BOKCHAE_SYSTEM_WORKLOG.md)** | 복채 시스템 작업 기록                               |
| **[DESIGN_SYSTEM.md](./DESIGN_SYSTEM.md)**                   | Tailwind 설정 상세, CSS 변수, 디자인 토큰           |
| **[PROJECT_RULES.md](./PROJECT_RULES.md)**                   | 클린 코드 규칙, 레이어 분리 원칙                    |
| **[TROUBLESHOOTING.md](./TROUBLESHOOTING.md)**               | 자주 발생하는 오류 및 해결책                        |

### 보조 문서

| 폴더           | 파일                                                                           |
| -------------- | ------------------------------------------------------------------------------ |
| `USER_GUIDES/` | ADMIN_VERIFICATION.md, AUTOMATION_SETUP.md, LOGIN_TEST_GUIDE.md, USER_GUIDE.md |
| `REPORTS/`     | SUPABASE_FULL_ANALYSIS.md                                                      |
