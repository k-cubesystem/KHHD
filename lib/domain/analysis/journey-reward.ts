 ...
 * - 신위: 2품 명신(싱글 멤버십 등급) 4좌 — 기원(祈願) 트랙과 겹치지 않음
 * - 테마: 기원 보상 트랙에 없는 싱글 등급 테마 4종
 * 완주 선물은 등급과 무관하게 남는 소유다(해지해도 남는다).
 * 등급·이름·활성 여부는 서버가 DB 값만 신뢰한다(여기 name 은 표시 폴백).
 *
...
export const JOURNEY_REWARD_CHOICES: readonly JourneyRewardChoice[] = Object.freeze([
  // ── 신위(2품 명신) ──
  {
    ...
    name: '바리공주',
    element: '물',
    tagline: '버려진 길 끝에서 생명을 살린 이끎의 신',
  },
  { kind: 'deity', code: 'daegam', name: '대감신', element: '쇠', tagline: '집안의 재물과 곳간을 지키는 풍요의 신' },
  { kind: 'deity', code: 'dokkaebi', name: '도깨비 대장', element: '불', tagline: '심술과 복을 함께 부리는 변화의 신' },
  { kind: 'deity', code: 'eopsin', name: '업신', element: '흙', tagline: '터에 깃들어 가업을 불리는 축적의 신' },
  // ── 테마신당 ──
  {
    kind: 'theme',
    code: 'dangsan',
  ...
  { kind: 'theme', code: 'naru', name: '안개 나루터', element: '물', tagline: '물안개 너머로 길을 잇는 경계의 공간' },
] as const)
