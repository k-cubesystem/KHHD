 ...
 * 설명 생성
 */
function generateDescription(score: number, _type: string): string {
  if (score >= 90) {
 ...
 */
export function calculateSimpleCompatibility(saju1: SajuData, saju2: SajuData): { score: number; comment: string } {
