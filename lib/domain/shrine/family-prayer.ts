...
/**
 * 100편 상한 정리의 **하한선** — 이 시각 이후에 올린 기도만 상한 대상이다.
 *
 * 🔴 `is_owner_wish` 는 백일기도 v3 의 표식이 아니다. 2026-06-21 부터 「주인이 남긴 소원」
 *    전부에 붙어 있던 플래그다. 그래서 상한 정리가 기도와 무관한 **구 소원까지 쓸어
 *    영구 삭제**했다(2026-08-26 발견·수복). 백일기도 서사에 속하지 않는 기록은 건드리지 않는다.
 */
export const PRAYER_PRUNE_SINCE = '2026-08-25T00:00:00.000Z'
