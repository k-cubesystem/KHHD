...
const REQUIRED_CLASSES = [
  ...
  '.obangki-burst',
  '.obangki-bubble',
  // 의식 게임필 (2026-09-04) — 엽전 3D 네 겹 · 접지 표식 · 산통 · 낙관 / 다발 그림자 · 방울 고리 · 천 결 /
  // 달아오름 · 섬광 · 진동 · 재 · 불티 · 낙관. 접지 표식(.chuljeon-land)의 animationend 가 흙먼지·소리를
  // 몰므로 CSS 가 빠지면 연출만 조용히 죽는다 — 정확히 이 게이트가 막을 종류다.
  '.chuljeon-arc',
  '.chuljeon-spin',
  '.chuljeon-face',
  '.chuljeon-face-front',
