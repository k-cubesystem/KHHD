      ...
      <CardContent className="p-0">
        ...
        >
          <div className="flex gap-4 p-6 min-w-max">
            {periods.map((period, idx) => {
              const element = period.pillar.ganElement
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {/* 오행 색상 바 */}
                    <div className="h-2 w-full rounded-t-sm" style={{ backgroundColor: elementColor }} />
                    ...
                    <div className="p-4 space-y-3">
                      ...
                      <div className="text-center">
                        <div className="flex items-center justify-center gap-2 mb-2">
                          <span className="text-3xl font-serif font-bold text-zen-text">{period.pillar.gan}</span>
                          <span className="text-3xl font-serif font-bold text-zen-text">{period.pillar.ji}</span>
                        </div>
                      ...
                      <div className="flex items-center justify-center gap-1">
                        <div className="w-2 h-2 rounded-full" style={{ backgroundColor: elementColor }} />
        ...
        <div className="text-center px-6 pb-6 pt-2 border-t border-zen-border bg-zen-bg/30">
          <p className="text-xs text-zen-muted italic leading-relaxed">
            * 대운은 10년 단위로 변화하는 인생의 큰 흐름입니다.
            <br />각 대운마다 오행의 기운이 달라지며, 이에 따라 운세의 방향성이 결정됩니다.
          </p>
        </div>
      </CardContent>
    </Card>
