    ...
    <div className="w-full max-w-[520px] mx-auto" style={themeVars(activePack)}>
      ...
      <div className="flex items-center justify-between px-1 pb-2.5">
        ...
        <div className="flex items-center gap-2">
          {/* 신당 꾸미기 — 신당테마·아이템·신위·신수 네 갈래를 묶은 단 하나의 버튼(CEO 6차 지시 ③).
              라벨 이력: 「모아보기」→「신당테마」→「신당 꾸미기」(4탭을 아우르는 이름으로 확정).
              종전 「신위」 버튼 자리를 그대로 이어받았다: 같은 결·같은 크기라 손이 기억하는 자리가 바뀌지 않는다.
              보이는 글자가 접근성 이름의 앞머리여야 한다(WCAG 2.5.3) — aria-label 은 「신당 꾸미기」로 시작한다. */}
          {isOwner && (
            <Link
              href={collectionHref}
              ...
              aria-label="신당 꾸미기 · 테마 · 아이템 · 신위 · 신수"
            >
