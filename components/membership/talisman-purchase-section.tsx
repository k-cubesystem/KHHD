                            ...
                            <div className="p-4">
                                ...
                                <div className="flex items-center justify-between mb-3">
                                    ...
                                    <div className="text-right flex-shrink-0 ml-3">
                                        ...
                                        {discount > 0 && (
                                            <div className="text-[9px] text-green-400 font-bold text-right">
                                                {discount}% 할인
                                            </div>
                                        )}
                                    </div>
                                ...
                                <div className={cn(
                                    ...
                                    <span className={cn(
                                        "text-sm font-bold",
                                        isPopular ? "text-gold-300" : "text-white/80"
                                    )}>
                                        복채 {plan.credits}만냥 지급
                                    </span>
                                    <span className="ml-auto text-[9px] text-white/40">
                                        단가 {plan.price / plan.credits / 1000 % 1 === 0
                                            ? plan.price / plan.credits / 1000
                                            : (plan.price / plan.credits / 1000).toFixed(1)}천원/복채
                                    </span>
                                </div>
