  ...
  return (
    ...
    >
      ...
      <div className="p-8">
        {/* Header */}
        <div className="mb-6">
          <Badge className={cn('mb-3 rounded-none', theme.badge)}>{plan.tier}</Badge>
          <h3 className="text-2xl font-serif font-bold text-ink-light mb-2">{plan.name}</h3>
        ...
        {/* Note */}
        <p className="text-xs text-ink/40 text-center mt-4">언제든 해지 가능 · 위약금 없음</p>
      </div>
    </Card>
  )
}
