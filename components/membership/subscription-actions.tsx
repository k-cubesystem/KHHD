...
import { cancelSubscription, reactivateSubscription, changeBillingMethod } from "@/app/actions/subscription-actions";
            ...
            {isActive && (
                <AlertDialog>
                    ...
                    <AlertDialogContent className="bg-white border-zen-border rounded-sm">
                        ...
                        <AlertDialogFooter>
                            <AlertDialogCancel className="rounded-sm border-zen-border">
                                취소
                            </AlertDialogCancel>
                            <AlertDialogAction
