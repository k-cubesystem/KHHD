    ...
    return (
        <div className="relative min-h-screen bg-gradient-to-b from-ink-900 via-ink-800 to-ink-900 overflow-hidden">
            ...
            <div className="absolute inset-0 pointer-events-none">
                ...
                <div className="absolute bottom-0 right-1/4 w-32 h-96 bg-gradient-to-t from-white/10 via-white/5 to-transparent blur-3xl animate-breathe" style={{ animationDelay: "2s" }} />
            ...
            <div className="relative z-10 container max-w-4xl mx-auto px-4 py-8">
                ...
                <Card className="bg-ink-800/50 border-gold-500/20 backdrop-blur-sm shadow-2xl">
                    <CardHeader className="border-b border-gold-500/20">
                        <CardTitle className="text-gold-300 text-center font-serif">
                            신당 상담실
                        </CardTitle>
                    </CardHeader>
