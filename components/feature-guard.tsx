...
export function FeatureGuard({ feature, children, fallback, showLockIcon = true }: FeatureGuardProps) {
  ...
  if (!isActive) {
    ...
    return (
      ...
      >
        <div className="opacity-40 grayscale pointer-events-none select-none filter blur-[1px]">{children}</div>
