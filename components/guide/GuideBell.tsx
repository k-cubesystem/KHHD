...
const TOURS: Record<string, readonly string[]> = {
  '/protected/analysis': [
    ...
    '오늘의 운세는 날마다 새로 내려오고, 언제나 무료로 보실 수 있어요.',
  ...
  '/protected/store': [
    '이곳은 봉헌소 — 이용권·멤버십·신당 테마·신물을 한 곳에서 살펴봅니다.',
    '신당 테마는 멤버십 등급에 따라 열리고, 본인·가족 신당 어디에든 적용할 수 있어요.',
    '「기억의 함」을 신당에 모시면 신이 문답을 90일 더 오래 기억합니다.',
  ],
  '/protected/profile': [
    '나의 서재입니다. 이용권·멤버십·분석 기록을 한눈에 볼 수 있어요.',
    '출석 도장을 찍으면 신당 정성이 하루씩 쌓입니다.',
  ...
  // 🔴 «언제든» 금지 — 보관 개수를 넘기면 오래된 기록부터 지워지고, 무료는 열람 기간이 있다.
  '/protected/history': ['지난 분석 기록이 이곳에 쌓입니다. 보관 개수와 열람 기간은 멤버십 등급마다 달라요.'],
}
