...
export function NotificationSettings() {
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Save Indicator */}
            {saved && (
                <div className="flex items-center justify-center gap-2 text-sm text-green-400 animate-in fade-in duration-200">
