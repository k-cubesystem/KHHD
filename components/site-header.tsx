          ...
          {user ? (
            <div className="flex items-center gap-3">
              ...
              <Link
                ...
                className="flex items-center gap-1.5 px-2 py-1 rounded-full bg-surface/30 border border-primary/20"
              >
            ...
            <Link
              href="/auth/login"
              className="text-xs font-bold text-primary border border-primary/30 px-3 py-1.5 rounded-full bg-surface/20"
            >
              로그인
            </Link>
          )}
