        ...
        <>
            ...
            <nav className="fixed bottom-0 left-0 right-0 z-50 bg-[#0A0A0A]/90 backdrop-blur-xl border-t border-white/10 pb-safe-area md:hidden">
                <div className="flex justify-around items-center h-16">
                    ...
                    <Link href="/protected/saju/today" className={cn("flex flex-col items-center gap-1 w-full", activeLink("/protected/saju/today") ? "text-[#D4AF37]" : "text-muted-foreground hover:text-white")}>
            ...
            <div className="hidden md:flex fixed bottom-6 left-1/2 -translate-x-1/2 z-50">
                <div className="flex items-center gap-1 px-3 py-2 rounded-2xl bg-black/80 backdrop-blur-xl border border-white/10 shadow-2xl">
                    ...
                    <Link
                        ...
                        className={cn(
                            "flex items-center gap-2 px-4 py-2 rounded-xl transition-all",
                            activeLink("/protected/saju/today") ? "bg-[#D4AF37] text-black" : "hover:bg-white/10 text-yellow-400"
                        )}
                    >
