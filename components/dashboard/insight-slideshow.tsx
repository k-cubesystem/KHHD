            ...
            <div className="relative min-h-[140px] p-6 flex flex-col justify-center">
                <AnimatePresence mode="wait">
                    ...
                    >
                        ...
                        <h3 className="text-lg font-serif font-bold text-ink-light leading-snug">
                ...
                <div className="absolute bottom-6 left-6 flex gap-1.5">
                    {SLIDES.map((_, idx) => (
                        <div
                            key={idx}
                            className={`w-1.5 h-1.5 rounded-full transition-all duration-300 ${idx === current ? "bg-primary w-4" : "bg-white/10"
                                }`}
                        />
                    ))}
                </div>
