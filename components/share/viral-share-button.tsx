...
export function ViralShareButton({ title, description, ogParams, url, className }: ViralShareButtonProps) {
  ...
  return (
    <>
      <Button onClick={() => setOpen(true)} variant="outline" className={cn('gap-2', className)}>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg overflow-hidden border border-zen-border">
              <img src={ogImageUrl} alt="공유 이미지 미리보기" className="w-full h-auto" />
            </div>
            ...
            <p className="text-xs text-zen-muted text-center">SNS에 공유하여 친구들과 함께 운세를 확인해보세요</p>
          </div>
        </DialogContent>
      </Dialog>
    </>
