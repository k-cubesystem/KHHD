...
5. **다음**: P2-10 가이드 투어 서버 저장·온보딩, P2-11 unlock_effect 2~4호(향로·초롱·놋방울·복부적)
6. 상시: P0-1 Sentry 경보 + P0-2 prod e2e 자동화 (스펙 9종 축적됨 — 파이프라인만 붙이면 됨)
7. 대기: P1-6 무료신 패키지(사용자 보류), P1-8 결제 전략 4건(사용자 결정), P3-16 가족 신당 공개 정책
