...
import {
    Heart, Sparkles, Loader2, Users, Calendar,
    TrendingUp, Star, Briefcase, UserPlus, ChevronRight
} from "lucide-react";
...
import { getInviterByCode, analyzeCompatibility } from "@/app/actions/invite-actions";
                ...
                {step === "result" && compatibility && inviter && (
                    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
                        ...
                        <div className="grid grid-cols-3 gap-3">
                            {[
                                { label: "연애궁합", score: compatibility.loveScore, icon: Heart, color: "text-pink-400" },
                                { label: "일궁합", score: compatibility.workScore, icon: Briefcase, color: "text-blue-400" },
                                { label: "친구궁합", score: compatibility.friendScore, icon: Users, color: "text-green-400" },
                            ].map((item) => (
