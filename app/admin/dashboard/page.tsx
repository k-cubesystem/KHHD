          ...
          >
            ...
            <div className="relative flex flex-col gap-2.5 md:gap-3">
              <div className="flex items-center justify-between">
                ...
                <div className={`p-1.5 md:p-2 rounded-lg ${stat.iconBg} group-hover:scale-110 transition-transform duration-300`}>
                  <stat.icon className={`w-3.5 h-3.5 md:w-4 md:h-4 ${stat.color} drop-shadow-sm`} strokeWidth={2.5} />
                </div>
              </div>
              <p className="text-base md:text-2xl font-black text-stone-100 truncate font-serif tracking-tight">{stat.value}</p>
            </div>
      ...
      <Card className="relative p-4 md:p-6 bg-gradient-to-br from-stone-800/30 to-stone-900/20 border border-stone-700/30 overflow-hidden">
        ...
        <div className="relative space-y-0">
          {stats.recentPayments.length === 0 ? (
            ...
            stats.recentPayments.map((payment: Payment, index: number) => (
              <div
                key={payment.id}
              ...
              >
                ...
                <div className="text-right flex-shrink-0 space-y-0.5">
                  ...
                  <span
                    className={`inline-block text-[9px] md:text-[10px] px-2 py-0.5 rounded-full font-bold ${payment.status === "completed"
