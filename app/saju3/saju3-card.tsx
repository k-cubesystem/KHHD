...
export function TypeHeadline({ type }: { type: TypeInfo }) {
  return (
    <header className="text-center">
      ...
      {/* 이 헤드라인은 유형별 공유 랜딩(/saju3/[type]) 전용이고 그 문서의 최상위 제목이다.
          h2 로 두면 페이지에 h1 이 0개가 된다 — 검색·스레드 유입을 받는 10장이라 치명적이다. */}
      <h1 className="mt-2.5 break-keep font-serif text-[26px] leading-tight text-gold-300">「{type.title}」</h1>
