 ...
 */
export async function canAddRelationship(): Promise<{ allowed: boolean; current: number; limit: number; message?: string }> {
    const supabase = await createClient();
    const { data: { user } } = await supabase.auth.getUser();
 ...
 */
export async function canUseTalisman(): Promise<{ allowed: boolean; used: number; limit: number; message?: string }> {
    const supabase = await createClient();
    const { data: { user } } = await supabase.auth.getUser();
 ...
 * Check storage limit
 */
export async function canStoreResult(): Promise<{ allowed: boolean; current: number; limit: number; message?: string }> {
    const supabase = await createClient();
    const { data: { user } } = await supabase.auth.getUser();
