...
const getGeminiModel = () => {
    ...
    return genAI.getGenerativeModel({ model: "gemini-3-flash-preview", generationConfig: { responseMimeType: "application/json" } });
};
...
export async function analyzeChonjiin(sajuInfo: string, metaInfo: string = "정보 없음", concern: string = "전반적인 운세") {
    return runAnalysis(
        "CHONJIIN_MASTER",
        "CHONJIIN",
