...
import { getUserTierLimits, getUserLimitsSummary } from '@/app/actions/payment/membership'
import { getWalletBalance } from '@/app/actions/payment/wallet'
import { getUserFiveElements } from '@/app/actions/core/saju'
      ...
      <div className="relative container mx-auto px-4 py-8 space-y-8">
        ...
        <header className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-bold text-zen-text font-serif">{tierLabels[tier]}</h1>
        ...
        <section>
          ...
          <DashboardStats balance={balance} summary={summary} tier={tier} />
        </section>

        {/* 오행 차트 */}
        <section className="bg-surface/30 rounded-xl p-6 border border-zen-border">
          <h2 className="text-xl font-bold text-zen-text mb-4 text-center">나의 오행 분포</h2>
