...
import { issueBillingKey, executeFirstPayment } from "@/app/actions/subscription-actions";
                    ...
                    {(step === "issuing" || step === "paying") && (
                        <div className="space-y-6 animate-in fade-in duration-500">
                            ...
                            <div className="flex items-center justify-center gap-2 pt-4">
                                <div className={`w-3 h-3 rounded-full transition-colors ${step === "issuing" ? "bg-primary" : "bg-white/10"}`} />
                                <div className="w-8 h-px bg-white/10" />
                                <div className={`w-3 h-3 rounded-full transition-colors ${step === "paying" ? "bg-primary" : "bg-white/10"}`} />
                                <div className="w-8 h-px bg-white/10" />
