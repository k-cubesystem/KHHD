...
import { Crown, Calendar, CreditCard, Clock, History, Gift, AlertTriangle, Coins, Sparkles, ShieldCheck, Zap } from "lucide-react";
            ...
            <div className="max-w-4xl mx-auto space-y-8">
                ...
                <div className="text-center space-y-4 mb-12">
                    ...
                    <p className="text-zen-muted font-sans text-sm md:text-base max-w-2xl mx-auto">
                        매달 전해지는 천기를 무제한으로 누리는 멤버십과<br className="hidden md:block" />
