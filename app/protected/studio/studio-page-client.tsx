  ...
  return (
    <div className="min-h-screen bg-background text-ink-light font-sans relative pb-24 overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-64 bg-gold-500/5 blur-[80px] rounded-full" />
      </div>
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-serif font-bold text-ink-light leading-snug mb-3">
              ...
              <span
                ...
                style={{
                  background: `linear-gradient(135deg, ${GOLD_300} 0%, ${GOLD_500} 100%)`,
        ...
        {SERVICES.map((service, i) => (
          ...
          >
            <Link href={service.href} className="block group">
              <div
                className="relative overflow-hidden rounded-2xl border border-white/5 p-5 transition-all duration-300 hover:border-gold-500/25 hover:shadow-[0_0_24px_rgba(212,175,55,0.08)]"
                style={{
              ...
              >
                ...
                {/* 타이틀 */}
                <h3 className="text-lg font-serif font-bold text-white/85 mb-1.5 group-hover:text-gold-500 transition-colors duration-300">
                  {service.label}
                ...
                <div className="flex gap-1.5 flex-wrap">
                  {service.tags.map((tag) => (
                    <span
                      key={tag}
                      className="text-[9px] text-gold-500/50 font-medium bg-gold-500/5 border border-gold-500/10 px-2 py-0.5 rounded-full"
                    >
                      #{tag}
                    </span>
                  ))}
