...
function FaceAnalysisPageContent() {
    ...
    const [selectedGoal, setSelectedGoal] = useState<FaceDestinyGoal>("wealth"); // Default to wealth
    ...
    const selectedGoalInfo = GOAL_OPTIONS.find((g) => g.value === selectedGoal);
                    ...
                    <Card className="card-glass-manse p-6 border-[#D4AF37]/20">
                        ...
                        <div className="space-y-3">
                            {GOAL_OPTIONS.map((goal) => (
                                <label
                                    key={goal.value}
                                    className={`flex items-center gap-4 p-4 rounded-lg border-2 cursor-pointer transition-all ${selectedGoal === goal.value
                                ...
                                >
                                    <input
                                        ...
                                        onChange={() => setSelectedGoal(goal.value)}
                                        className="w-5 h-5 text-[#D4AF37] accent-[#D4AF37]"
                                    />
                                    <div
                                        className={`w-10 h-10 rounded-full bg-black/30 flex items-center justify-center ${goal.color}`}
                                    >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-xs text-white/60 font-sans">{goal.desc}</p>
                                    </div>
                                </label>
                            ))}
                        </div>
            ...
            {step === "result" && analysisResult && (
                ...
                >
                    ...
                    <ShareSaveButtons
                        ...
                        analysisTitle={`관상 분석 (${selectedGoalInfo?.label})`}
                    ...
                    <div className="flex gap-3">
                        <Button
                            onClick={() => {
                                ...
                                setSelectedGoal("wealth"); // Reset to default
                            }}
                            variant="outline"
