...
} from "@/app/actions/family-missions";
...
function FengShuiAnalysisPageContent() {
    ...
    const selectedThemeInfo = THEME_OPTIONS.find((t) => t.value === selectedTheme);
                        ...
                        <div className="grid grid-cols-3 gap-2">
                            {ROOM_TYPES.map((room) => (
                                <button
                                    ...
                                    className={`p-3 rounded-lg text-sm font-sans transition-all ${selectedRoom === room.value
                    ...
                    <Card className="card-glass-manse p-6 border-[#D4AF37]/20">
                        ...
                        <div className="space-y-3">
                            {THEME_OPTIONS.map((theme) => (
                                <label
                                    key={theme.value}
                                    className={`flex items-center gap-4 p-4 rounded-lg border-2 cursor-pointer transition-all ${selectedTheme === theme.value
                                ...
                                >
                                    <input
                                        ...
                                        className="w-5 h-5 text-[#D4AF37] accent-[#D4AF37]"
                                    />
                                    <div
                                        className={`w-10 h-10 rounded-full bg-black/30 flex items-center justify-center ${theme.color}`}
                                    >
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <p className="text-xs text-white/60 font-sans">{theme.desc}</p>
                                    </div>
                                </label>
                            ))}
                        </div>
            ...
            {step === "result" && analysisResult && (
                ...
                >
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-3">
                                    {selectedThemeInfo && (
                                        <>
                                            <div
                                                className={`w-10 h-10 rounded-full bg-black/30 flex items-center justify-center ${selectedThemeInfo.color}`}
                                            >
                                                <selectedThemeInfo.icon className="w-5 h-5" />
                                            </div>
                                            <div>
                    ...
                    <ShareSaveButtons
                        ...
                        analysisTitle={`풍수 분석 (${selectedThemeInfo?.label} - ${selectedRoom})`}
