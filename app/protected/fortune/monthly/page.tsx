  ...
  return (
    <div className="min-h-screen bg-background text-ink-light pb-20">
      <header className="px-6 pt-12 pb-6">
        ...
        <p className="text-sm text-ink-light/60">{new Date().getFullYear()}년 {new Date().getMonth() + 1}월</p>
      </header>

      <section className="px-6">
        <Card className="bg-surface/30 border-primary/20">
          <CardContent className="p-12 text-center">
            <CalendarRange className="w-16 h-16 text-primary/50 mx-auto mb-4" />
            <h3 className="text-lg font-serif text-ink-light mb-2">월간 운세 준비 중</h3>
            <p className="text-sm text-ink-light/60">곧 업데이트됩니다</p>
          </CardContent>
        </Card>
      </section>
    </div>
