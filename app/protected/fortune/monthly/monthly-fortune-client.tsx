                ...
                <div className="relative inline-block">
                  <svg width="100" height="100" className="mx-auto -rotate-90">
                    ...
                    <motion.circle
                      ...
                      animate={{ strokeDashoffset: 2 * Math.PI * 42 * 0.3 }}
                      transition={{ duration: 1.2, ease: 'easeOut' }}
                    />
                  </svg>
                  <div className="absolute inset-0 flex flex-col items-center justify-center">
                    <span className="text-lg font-light text-primary">{data.summary}</span>
                  </div>
                </div>
                <div>
          ...
          <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}>
            <Card className="bg-primary/5 border-primary/20">
              <CardContent className="p-5 space-y-2">
                ...
                <p className="text-sm text-ink-light/80 font-light leading-relaxed">{data.overall}</p>
              </CardContent>
            </Card>
          </motion.div>
                  ...
                  >
                    <Card className="bg-surface/20 border-white/5">
                      <CardContent className="p-4">
                        ...
                        <p className="text-xs text-ink-light/60 font-light leading-relaxed">{area.content}</p>
                      </CardContent>
                    </Card>
                  </motion.div>
                )
