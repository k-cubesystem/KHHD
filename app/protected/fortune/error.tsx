...
export default function FortuneError({ error, reset }: { error: Error & { digest?: string }; reset: () => void }) {
  useEffect(() => {
    logger.error('[운세 에러]', error)
  }, [error])
  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center px-4">
      <div className="w-full max-w-md text-center space-y-4">
        ...
        <h2 className="text-lg font-bold text-amber-200">운세 조회 중 문제가 발생했어요</h2>
