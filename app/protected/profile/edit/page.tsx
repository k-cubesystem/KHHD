...
export default async function ProfileEditPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0A192F] relative overflow-hidden">
      ...
      <div className="relative container max-w-3xl mx-auto px-4 md:px-3 py-8 space-y-6">
        {/* Back Button */}
        <Link
        ...
        <ProfileEditForm userId={user.id} initialData={sajuRecord} profileData={profile} />
      </div>
    </div>
  )
}
