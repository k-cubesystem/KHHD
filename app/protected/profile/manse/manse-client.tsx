...
const TERMINOLOGY: Record<string, { title: string; desc: string }> = {
    ...
    "천을귀인": { title: "천을귀인 (天乙貴人)", desc: "어려움에 처했을 때 도움을 주는 귀인이 나타나는 길신입니다. 위기 상황에서 예상치 못한 도움을 받을 수 있으며, 인복이 좋습니다." },
};
                        ...
                        <PremiumFeature title="용신론 (用神論)" isSubscribed={isSubscribed}>
                            <div className="space-y-6">
                                ...
                                <div className="space-y-2">
                                    ...
                                    <p className="text-sm text-muted-foreground leading-relaxed">
                                        용신인 木과 희신인 Water를 적극 활용하고, 기신인 金은 피하는 것이 운세 향상에 도움이 됩니다. 木 기운이 강한 환경과 직업을 선택하면 좋습니다.
                                    </p>
                                </div>
                            </div>
                        </PremiumFeature>
