...
export const metadata: Metadata = {
  title: '결제 취소',
  description: '이용권 구매 결제를 직접 취소하고 환불받으실 수 있습니다.',
}
  ...
  return (
    <div className="w-full max-w-[480px] mx-auto px-3 text-ink-light font-sans pb-16">
      <div className="px-1 py-4 flex items-center gap-4 border-b border-primary/10 mb-6">
        <Link href="/protected/store?tab=pass" className="p-1 -ml-1 hover:bg-surface/10 transition-colors rounded-full">
      ...
      <section className="mb-6 space-y-2 px-1">
        <p className="text-sm text-ink-light/70 font-light leading-relaxed">
          이용권 구매 결제를 직접 취소하실 수 있습니다. {chargeRefundPolicyLine()} (이용약관 제7조 제2항)
        </p>
        <p className="text-[11px] text-ink-light/40 font-light leading-relaxed">
          이미 풀이에 쓰신 이용권은 되돌릴 수 없어 자동 취소가 제한될 수 있습니다. 환불금은 결제하신 수단으로 돌아가며,
          카드사 사정에 따라 영업일 기준 최대 7일이 걸릴 수 있습니다.
        </p>
      </section>
